      ...
      <main className="flex h-full w-full flex-col space-y-6 rounded-2xl border border-border bg-surface p-8 shadow-md">
        <div>
          ...
          <p className="mt-1 text-sm text-muted">
            Describe the feature you&apos;d like. Requests are posted to the{' '}
            <a
              href="https://redo-tech.slack.com/archives/C0AU9L8FHNJ/p1776788510022329"
              target="_blank"
              rel="noopener noreferrer"
              className="underline underline-offset-2 hover:text-foreground"
            >
              features thread in Slack
            </a>
            .
          </p>
        </div>
        ...
        {submitted && !error && (
          <p className="text-xs text-foreground">Feature request submitted. Thanks!</p>
        )}
